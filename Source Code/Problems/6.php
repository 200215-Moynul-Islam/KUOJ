...
<html>
    ...
    <?php
            ...
            $sql="SELECT problem_name,time_limit,memory_limit,statement,input,output,explanation FROM problem where problem_id=6";
        ...
        <div class="content">
            <main>
                ...
                <div class="sample">
                    <?php
                        $sql="SELECT sample_input,sample_output FROM sample where problem_id=6";
                        $result=$connected->query($sql);
                    ?>
